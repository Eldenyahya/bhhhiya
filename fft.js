...
const User = [
  {
    type:'input',
    name:'username',
    message:'masukin username bujang'
  },
  {
    type:'password',
    name:'password',
  ...
  },
  {
    type:'input',
    name:'target',
    message:'Username Target  (Without @[at])'
  },
  {
    type:'input',
    name:'text',
    message:'komennya ,kalo mau tag yang punya post pakai {{username}} (Gunakan Pemisah [|] bila lebih dari 1)'
  },
  {
    type:'input',
    name:'sleep',
